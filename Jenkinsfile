pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/almafra/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('almafra-225')   // <---- Change this to match your kubernetes cluster credentials
    }
